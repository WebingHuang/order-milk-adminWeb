...
import HeadCut from '@/views/admin/shop/HeadCut'
import HeadCut1 from '@/views/admin/shop/HeadCut'

// 增删改查接口
import { editShop, deleteShop } from '@/api/shop'
import { getShopListPage } from '@/api/system'
   ...
   data() {
      ...
      return {
         ...
         loadData: (parameter) => {
            ...
            return getShopListPage(requestParameters, this.queryCondition)
               .then((res) => {
                  if (res.state == 2000) {
                     const pageData = {

                               ...
                               <div class="specs_list">
                                ...
                                <div class="specs_list_item"  v-for="(item,index) in specsList" :key="index">
                                  <div class="specs_list_item_lfte">
                                    <a-form-item label="名称"  :labelCol="{ lg: { span: 6 }, sm: { span: 16 } }" :required="true">
                                      <a-input  v-model="item.name" size="small" />
                                    </a-form-item>

                                    <a-form-item label="单价"  :labelCol="{ lg: { span: 6 }, sm: { span: 16 } }" :required="true">
                                      <a-input style="width: 3rem;" v-model="item.price" size="small"/>
                                    </a-form-item>
                                    ...
                                    <a-form-item label="库存数量"  :labelCol="{ lg: { span: 8 }, sm: { span: 16 } }" :required="true">
                                      <a-input style="width: 3rem;" v-model="item.number" size="small"/>
                                    </a-form-item>


                                    <a-form-model-item label="开启满赠"  :labelCol="{ lg: { span: 16 }, sm: { span: 16 } }">
                                        <a-switch default-checked :checked="item.isPresented" @click="item.isPresented = !item.isPresented"/>
                                    </a-form-model-item>

                                    <a-form-item label="满"  :labelCol="{ lg: { span: 6 }, sm: { span: 16 } }" :required="true" v-if="item.isPresented">
                                      <a-input style="width: 3rem;" v-model="item.buyEnoughNum" size="small"/>
                                    </a-form-item>

                                    <a-form-item label="赠"  :labelCol="{ lg: { span: 6 }, sm: { span: 16 } }" :required="true" v-if="item.isPresented">
                                      <a-input style="width: 3rem;" v-model="item.presenterNum" size="small"/>
                                    </a-form-item>
                                    ...
                                    <a-form-item label="封面" style="width: 150px;"  :labelCol="{ lg: { span: 6 }, sm: { span: 16 } }">

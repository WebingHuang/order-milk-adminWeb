        ...
        <div>
          ...
          >
            <a-form-model
              ...
              ref="ruleForm"
            >
              <a-form-model-item v-for="(item, key) in ruleForm.schoolClassEntities" :key="key" :label="(!state?(key+1 + '-'):'')+'班级名称'" :required="true">
                <a-input :name="(!state?(key+1 + '-'):'')+'班级名称'" v-model="item.className" >

      ...
      // },
      {
        ...
        children: [
          ...
          },
          {
            ...
            name: 'customers',
            hideChildrenInMenu: true, // 强制显示 MenuItem 而不是 SubMenu
            component: () => import('@/views/system/customer/Table'),
            meta: { title: '客服设置', keepAlive: true, permission: ['customers'] }
          },
          {
            path: '/system/notice',
            name: 'notices',
            hideChildrenInMenu: true, // 强制显示 MenuItem 而不是 SubMenu
            component: () => import('@/views/system/notice/Table'),
            meta: { title: '通知设置', keepAlive: true, permission: ['notices'] }
          },
          // {

...
export default {
  ...
  methods: {
    ...
    handleEdit(record) {
      ...
      this.userForm.schoolName = record.schoolName;
      this.userForm.className = record.className;
      this.userForm.schoolId = record.schoolId;
      this.userForm.classId = record.classId||'';
      ...
      this.$refs.userForm.validate((valid) => {
        ...
        if (!valid) {
          ...
          return editUser(this.state,this.state?
          {
            ...
            classId: this.userForm.classId||0,
          }:{
            //新增参数
            loginAccount:this.userForm.phone,

...
import {getAgentUserOrder,updateOrderStatus , getOrderInfoById ,getOrderExcel,putOderState} from '@/api/system'
...
export default {
  ...
  methods: {
    ...
    getAgentUserOrder(){
        ...
        return getAgentUserOrder(this.queryCondition)
          .then((res) => {
            this.exportExcl();
            if (res.code == 200) {
